...
class Perceptron:
	...
	def fit(self, images):
		images_features = feature_extraction.counting_extraction(images)
		predictions = []
...
def main():
	...
	digit_train_features = feature_extraction.counting_extraction(digit_train_images)
	face_train_features = feature_extraction.counting_extraction(face_train_images)
